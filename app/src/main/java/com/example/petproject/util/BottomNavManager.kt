...
class BottomNavManager(
    ...
    private val navGraphIds =
        listOf(R.navigation.nav_list, R.navigation.nav_market, R.navigation.nav_menu)
    ...
    private var navHistory = BottomNavHistory().apply { push(R.id.nav_list) }
    ...
    private fun isFirstTab(): Boolean {
        return bottomNavigationView.selectedItemId == R.id.nav_list
    }
